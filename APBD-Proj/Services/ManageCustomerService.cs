...
{ 
    ...
    Task<CustomerRequestModel> UpdateCustomer(long pesel, CustomerRequestModel customer);
...
public class ManageCustomerService (DatabaseContext context) : IManageCustomerService
{
        ...
        public async Task<CustomerRequestModel> UpdateCustomer(long pesel, CustomerRequestModel customer)
        {
